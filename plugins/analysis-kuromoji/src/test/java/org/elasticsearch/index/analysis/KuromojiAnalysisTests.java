...
public class KuromojiAnalysisTests extends ESTestCase {
  ...
  public AnalysisService createAnalysisService() throws IOException {
    ...
    Settings settings=Settings.settingsBuilder().put("path.home",home).loadFromClasspath("org/elasticsearch/index/analysis/kuromoji_analysis.json").put(IndexMetaData.SETTING_VERSION_CREATED,Version.CURRENT).build();
  ...
  @Test public void testKuromojiEmptyUserDict() throws IOException {
    AnalysisService analysisService=createAnalysisService();
