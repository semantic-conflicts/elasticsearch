...
public class KuromojiAnalysisTests extends ESTestCase {
  ...
  public AnalysisService createAnalysisService(){
    ...
    Settings settings=Settings.settingsBuilder().put("path.home",createTempDir()).loadFromStream(json,getClass().getResourceAsStream(json)).put(IndexMetaData.SETTING_VERSION_CREATED,Version.CURRENT).build();
